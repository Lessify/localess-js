---
name: localess-live-preview
description: Framework-neutral Visual Editor bridge for Localess — sync script loading, data-ll-* attributes, editor events, and a shared sync controller.
---
