...
<button use:localessEditable={data} type="button" class="{baseClass} {variantClass}">
  <span {...localessEditableField<Button>('label')}>{data.label}</span>
</button>
